...
from config import google_bucket_name, prices_blob_name, classes_blob_name, instructor_prices_blob_name
from constants import pricing_options_path, class_name_lookup_path, instructor_prices_options_path
...
class GoogleCloudStorageService:
    ...
    def fetch_instructor_prices(self):
        prices_blob = self.bucket.blob(instructor_prices_blob_name)
        prices_blob.download_to_filename(instructor_prices_options_path)

    def save_instructor_prices(self):
        prices_blob = self.bucket.blob(instructor_prices_blob_name)
        prices_blob.upload_from_filename(instructor_prices_options_path)
